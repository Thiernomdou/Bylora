...
export default function Faq() {
  ...
  return (
    <section id="faq" className="bg-white px-4 md:px-6 lg:px-10 py-16 md:py-20 lg:py-28">
      <div className="max-w-7xl mx-auto">
        <div className="max-w-2xl mb-12">
          ...
          <h2 className="text-[24px] md:text-[32px] lg:text-[42px] font-black text-gray-900 leading-tight tracking-tight">
            Tu as des questions ?
          </h2>
        </div>
