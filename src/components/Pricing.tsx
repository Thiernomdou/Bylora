const plans = [
  {
    ...
    per: "Idéal si ton examen ou entretien est dans moins d'un mois",
    popular: false,
    features: [
      "555 questions civiques et d'entretien",
      "Simulateur d'examen civique (QCM)",
  ...
  },
  {
    ...
    per: "Idéal si ton examen ou entretien est dans 2 à 3 mois",
    popular: true,
    features: [
      "555 questions civiques et d'entretien",
      "Simulateur d'examen civique (QCM)",
