export default function FounderNote() {
  return (
    <section className="bg-[#FAF4EC] border-y border-black/[0.07] px-4 md:px-6 lg:px-10 py-16 md:py-20 lg:py-28">
      <div className="max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <blockquote className="text-[20px] md:text-[26px] lg:text-[34px] font-bold text-gray-900 leading-snug mb-6 tracking-tight">
